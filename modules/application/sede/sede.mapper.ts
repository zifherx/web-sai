import { SedeResponseDTO } from "@/modules/application"
import { SedeEntity } from "@/modules/domain"
...
export class SedeMapper {
  static toDTO(entity: SedeEntity): SedeResponseDTO {
    return {
      ...
      horarioVentas: entity.horarioVentas,
      horarioTaller: entity.horarioTaller,
