...
// Índices para las consultas frecuentes del CMS
leadCorporativoSchema.index({ createdAt: -1 })
leadCorporativoSchema.index({ marcaId: 1 })
leadCorporativoSchema.index({ ciudad: 1 })
