...
export const LeadCorporativoIdSchema = z.object({
  id: z.string().length(24, "ID de MongoDB inválido"),
})

export const LeadCorporativoFiltersSchema = z.object({
...
>
export type LeadCorporativoFiltersDTO = z.infer<
  typeof LeadCorporativoFiltersSchema
>
