/**
 * INFRASTRUCTURE — Mongoose Schema: MediaRecord
 *
 * Representa el documento MongoDB para un MediaFile.
 * Colección: "media_records"
 *
 * Separado intencionalmente del modelo de dominio (MediaFile).
 * El mapper MongooseMediaMapper convierte entre ambos.
 */
import type {
  EntityType,
  FieldName,
...
// Índices para los filtros más frecuentes del CMS
mediaRecordSchema.index({ entityType: 1 })
mediaRecordSchema.index({ entityType: 1, entityId: 1 })
mediaRecordSchema.index({ fileKey: 1 })
