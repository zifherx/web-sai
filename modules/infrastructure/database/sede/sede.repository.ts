...
import { SedeDocument } from "@/modules/infrastructure"
...
export class MongooseSedeRepository implements ISedeRepository {
  ...
  private toEntity(doc: SedeDocument): SedeEntity {
    return {
      ...
      horarioVentas: doc.horarioVentas ?? {
        scheduleRegular: "",
        scheduleExtended: "",
      },
      horarioTaller: doc.horarioTaller ?? {
        scheduleRegular: "",
        scheduleExtended: "",
      },
  ...
  async create(data: ICreateSedeData): Promise<SedeEntity> {
    const doc = await this.model.create({
      ...
      horarioVentas: data.horarioVentas,
      horarioTaller: data.horarioTaller,
