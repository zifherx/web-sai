...
export const CreateSedeSchema = z.object({
  ...
  scheduleRegular: z
    .string()
    .min(1, "El horario regular es requerido")
    .optional(),
  scheduleExtended: z
    .string()
    .min(1, "El horario extendido es requerido")
    .optional(),
  horarioVentas: HorarioSchema,
  horarioTaller: HorarioSchema,
...
export const SedeSlugSchema = z.object({
...
export type HorarioResponseDTO = {
...
export type SedeResponseDTO = {
  ...
  scheduleRegular: string
  scheduleExtended: string
  horarioVentas: HorarioResponseDTO
  horarioTaller: HorarioResponseDTO
